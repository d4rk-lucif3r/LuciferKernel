...
git clone --depth=1 -b NonOC https://github.com/d4rk-lucif3r/LuciferKernel.git 
cd LuciferKernel
...
function zipping() {
    ...
    zip -r9 LuciferKernel+NonOC.zip *
    curl https://bashupload.com/LuciferKernel+NonOC.zip --data-binary @LuciferKernel+NonOC.zip
}
compile
zipping
